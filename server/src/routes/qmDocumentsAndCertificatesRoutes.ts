...
import { 
  ...
  createQMDocumentAndCertificate, 
  updateQMDocumentAndCertificate, 
  deleteQMDocumentAndCertificate 
} from "../controllers/qmDocumentsAndCertificatesController";
 ...
 */
router.get("/:id", getQMDocumentAndCertificateById);
 ...
 */
router.post("/", createQMDocumentAndCertificate);
 ...
 *         description: QM Document & Certificate bulunamadı
 */
router.put("/:id", updateQMDocumentAndCertificate);
 ...
 *         description: QM Document & Certificate bulunamadı
 */
router.delete("/:id", deleteQMDocumentAndCertificate);
