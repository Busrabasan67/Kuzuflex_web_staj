...
], ProductTranslation.prototype, "language", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], ProductTranslation.prototype, "title", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', length: 'MAX' }),
    __metadata("design:type", String)
], ProductTranslation.prototype, "description", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => Product_1.Product, (product) => product.translations, {
        onDelete: 'CASCADE',
    }),
