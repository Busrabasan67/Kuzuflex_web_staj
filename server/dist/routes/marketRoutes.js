 ...
 */
router.get("/id/:id", marketController_1.getMarketById);
router.get("/:marketId/contents", marketController_1.getMarketContents);
/**
 * @swagger
 * /api/markets/{slug}:
 *   get:
 ...
 *         description: Market not found
 */
router.get("/:slug", marketController_1.getMarketBySlug);
/**
 * @swagger
 * /api/markets:
 *   post:
 ...
 *               $ref: '#/components/schemas/Market'
 */
router.post("/", uploadController_1.uploadMarket.single("image"), marketController_1.createMarket);
/**
 * @swagger
 * /api/markets/{id}:
 *   put:
 ...
 *         description: Market not found
 */
router.put("/:id", uploadController_1.uploadMarket.single("image"), marketController_1.updateMarket);
/**
 * @swagger
 * /api/markets/{id}:
 *   delete:
 ...
 *         description: Market not found
 */
router.delete("/:id", marketController_1.deleteMarket);
/**
 * @swagger
 ...
 *         description: Market not found
 */
router.post("/:marketId/contents", marketController_1.createMarketContent);
/**
 * @swagger
 ...
 */
router.put("/contents/:id", marketController_1.updateMarketContent);
/**
 * @swagger
 * /api/markets/contents/{id}:
 *   delete:
 ...
 *         description: Content not found
 */
router.delete("/contents/:id", marketController_1.deleteMarketContent);
/**
 * @swagger
 ...
 *                     type: string
 */
router.get("/available/product-groups", marketController_1.getAvailableProductGroups);
/**
 * @swagger
 ...
 *                     type: string
 */
router.get("/available/solutions", marketController_1.getAvailableSolutions);
/**
 * @swagger
 ...
 *         description: Market not found
 */
router.delete("/:marketId/contents/clear", marketController_1.clearMarketContents);
