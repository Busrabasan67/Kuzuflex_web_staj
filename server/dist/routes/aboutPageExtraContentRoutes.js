...
const aboutPageExtraContentController_1 = require("../controllers/aboutPageExtraContentController");
const router = express_1.default.Router();
// Çoklu dil için ekstra içerik ekle
router.post('/multi', aboutPageExtraContentController_1.createMultiLanguageExtraContent);
// Tek ekstra içerik ekle
router.post('/', aboutPageExtraContentController_1.createExtraContent);
// Ekstra içerik getir
router.get('/:id', aboutPageExtraContentController_1.getExtraContent);
// Tüm ekstra içerikleri getir
router.get('/', aboutPageExtraContentController_1.getAllExtraContents);
// Dil bazında ekstra içerikleri getir
router.get('/language/:language', aboutPageExtraContentController_1.getExtraContentsByLanguage);
// Grup güncelleme - önce tanımlanmalı
router.put('/update-group', aboutPageExtraContentController_1.updateGroupExtraContent);
// Ekstra içerik güncelle
router.put('/:id', aboutPageExtraContentController_1.updateExtraContent);
// Ekstra içerik sil
router.delete('/:id', aboutPageExtraContentController_1.deleteExtraContent);
