...
const seedQMDocumentsAndCertificates = async () => {
    try {
        ...
        const qmDocumentsRepository = data_source_1.AppDataSource.getRepository(QMDocumentsAndCertificates_1.QMDocumentsAndCertificates);
        const translationsRepository = data_source_1.AppDataSource.getRepository(QMDocumentsAndCertificatesTranslation_1.QMDocumentsAndCertificatesTranslations);
...
exports.default = seedQMDocumentsAndCertificates;
